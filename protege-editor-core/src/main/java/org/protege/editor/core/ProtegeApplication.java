...
public class ProtegeApplication implements BundleActivator {
    ...
    private void setupDefaults(UIDefaults defaults, String lafClassName) {
        ...
        if (flatLookAndFeel) {
            ...
            defaults.put("Component.focusedBorderColor", ModernProtegeTheme.SELECTION_BORDER);
            ...
            defaults.put("Button.default.background", ModernProtegeTheme.SELECTION);
            defaults.put("Button.default.foreground", Color.WHITE);
            defaults.put("Button.default.hoverBackground", ModernProtegeTheme.blend(ModernProtegeTheme.SELECTION, Color.WHITE, 0.12f));
            defaults.put("Button.default.pressedBackground", ModernProtegeTheme.blend(ModernProtegeTheme.SELECTION, Color.BLACK, 0.12f));
            defaults.put("Button.default.borderColor", ModernProtegeTheme.SELECTION);
            defaults.put("Button.default.focusedBorderColor", ModernProtegeTheme.SELECTION_BORDER);
            ...
            defaults.put("ComboBox.buttonBackground", ModernProtegeTheme.SURFACE);
            defaults.put("ComboBox.selectionBackground", ModernProtegeTheme.SELECTION_SOFT);
            defaults.put("ComboBox.selectionForeground", ModernProtegeTheme.SELECTION);
            ...
            defaults.put("TabbedPane.tabAreaInsets", new Insets(4, 6, 0, 6));
            defaults.put("TabbedPane.selectedForeground", ModernProtegeTheme.SELECTION);
            defaults.put("TabbedPane.underlineColor", ModernProtegeTheme.SELECTION);
            defaults.put("TabbedPane.hoverColor", ModernProtegeTheme.CONTROL_HOVER);
            defaults.put("TabbedPane.focusColor", ModernProtegeTheme.SELECTION_SOFT);
            ...
            defaults.put("Table.alternateRowColor", ModernProtegeTheme.SURFACE_ALT);
            ...
            defaults.put("Tree.selectionBorderColor", ModernProtegeTheme.SELECTION_BORDER);
            ...
            defaults.put("List.selectionInactiveBackground", ModernProtegeTheme.SELECTION_SOFT);
            defaults.put("List.selectionInactiveForeground", ModernProtegeTheme.TEXT);
